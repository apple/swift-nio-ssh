...
extension SendsKeyExchangeMessages {
    mutating func sendKeyExchangeMessage(_ message: SSHMessage.KeyExchangeMessage, into buffer: inout ByteBuffer) throws {
        self.keyExchangeStateMachine.send(keyExchange: message)
        try self.serializer.serialize(message: .keyExchange(message), to: &buffer)

    }

    mutating func sendKeyExchangeInitMessage(_ message: SSHMessage.KeyExchangeECDHInitMessage, into buffer: inout ByteBuffer) throws {
    ...
    mutating func sendKeyExchangeReplyMessage(_ message: SSHMessage.KeyExchangeECDHReplyMessage, into buffer: inout ByteBuffer) throws {
    ...
    mutating func sendNewKeysMessage(into buffer: inout ByteBuffer) throws {
